<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicHealth.aspx.cs" Inherits="practise_coding.PublicHealth" %>
     ...
     <asp:DropDownList ID="DropDownList1" runat="server" >
         ...
         <asp:ListItem Text="Gynaecologist" Value="Gynaecologist"></asp:ListItem>
          ...
          <asp:ListItem Text="Virtual Consult" Value="Virtual Consult"></asp:ListItem>
                   ...
                   <div>
                   <asp:GridView ID="GridViewAvailabledoc" runat="server"></asp:GridView>
               </div>
               <div ">
                 <asp:Button ID="btnCheckAppoint" runat="server" Text="Check Availabity" CssClass="btn btn-primary"  /> 
